...
import {
  ...
  Globe, Video, Flame, Inbox,
  Cpu, Laptop, Shield, Cloud, Radio, FileText as FileTextIcon,
} from "lucide-react";
      ...
      {filtered.length === 0 ? (
        <div className="card p-16 text-center">
          <div className="mb-4 flex justify-center">
            <Inbox size={44} className="text-slate-300" />
          </div>
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-2 flex-wrap">
            ...
            {hot && ev.status === "approved" && (
              <span className="status-badge bg-red-50 text-red-600 border border-red-200 text-xs">
    ...
    <div className="card overflow-hidden card-hover animate-slide-up"
      ...
      <div className={`bg-gradient-to-br ${ev.gradient} h-32 flex items-center justify-center relative`}>
        ...
        <span className="relative z-10">
          <BannerIcon size={44} className="text-white" />
        </span>
